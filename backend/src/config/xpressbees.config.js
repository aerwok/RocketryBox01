...
export const XPRESSBEES_CONFIG = {
  ...
  API_BASE_URL: process.env.XPRESSBEES_API_URL || 'https://ship.xpressbees.com',
...
try {
  ...
  // console.log('✅ XpressBees configuration loaded successfully');
  // console.log(`📧 Email: ${XPRESSBEES_CONFIG.AUTH.EMAIL}`);
  // console.log(`🌐 API Base URL: ${XPRESSBEES_CONFIG.API_BASE_URL}`);
  // console.log(`🚚 Service Types: ${Object.keys(XPRESSBEES_CONFIG.SERVICE_TYPES).length} available`);
} catch (error) {
  console.warn('⚠️ XpressBees configuration warning:', error.message);
}
